...
begin
  ...
  try
    ...
    {5.1. Den Teilnehmern in einer Spielgruppe werden wie folgt Punkte zugeteilt bzw. angerechnet:
          ▪ in einer MK: für jedes gewonnene MSp drei (3) Punkte, für jedes MSp mit unentschiedenem Ausgang
          ( d.h. mit der gleichen Anzahl an gewonnenen Spielen für jede der beiden an diesem MSp beteiligten
          Mannschaften ) zwei (2) Punkte, für jedes verlorene MSp ein (1) Punkt und für jedes Mannschafts-Forfait
          null (0) Punkte;
          ▪ in einer IK: für jedes gewonnene Spiel ( Einzel bzw. Doppel ) zwei (2) Punkte, für jedes verlorene Spiel
          ein (1) Punkt und für jedes Spiel zu dem der Teilnehmer nicht angetreten ist (= 'Forfait') oder bei dem er
          disqualifiziert worden ist, null (0) Punkte.
          Die Tabelle einer Spielgruppe wird erstellt, indem für jeden Teilnehmer dieser Spielgruppe die von diesem
          Teilnehmer - gemäß den Bestimmungen des vorherigen Absatzes - erzielten Punkte summiert werden.
          ( siehe diesbezüglich auch Art. 0.06.).
     6.1. Bei Gleichstand ( = bei gleicher Punktezahl) von zwei oder mehr Teilnehmern in der Abschlusstabelle einer
          ...
          ausgetragen haben und die für die Erstellung der Tabelle der betreffenden Spielgruppe maßgebend sind
          bzw. waren, und zwar in der folgenden Reihenfolge: zuerst das bessere (= höhere) Spielverhältnis (51H) (51J)
          ,
          dann das bessere (= höhere) Satzverhältnis (51J)
          , soweit dies für die Festlegung der Platzreihenfolge (noch)
          notwendig ist.
    }
    z.SQL.Clear;
